...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\PizzaTime\\MyDatabase.mdf;Integrated Security=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrdersPizza>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.OrdersPizzas)
                ...
                .HasConstraintName("OrdersPizza_ToOrders");

            entity.HasOne(d => d.Pizza).WithMany(p => p.OrdersPizzas)
                .HasForeignKey(d => d.Pizzaid)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("OrdersPizza_ToPizza");
        });
